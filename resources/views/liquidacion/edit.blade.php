...
@section('content')
    <form action="/liquidaciones/{{$liquidacion->id}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input id="numRepartidor" name="numRepartidor" type="number" min="1" max="9999" class="form-control" value="{{$liquidacion->numRepartidor}}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input id="recojidas" name="recojidas" type="number" min="1" max="300" class="form-control" value="{{$liquidacion->recojidas}}">
        </div>
        <div class="mb-3">
            <label for="" class="form-label">Incidencias</label>
            <input id="incidencias" name="incidencias" type="number" min="1" max="300" class="form-control" value="{{$liquidacion->incidencias}}">
        </div>
        <div class="mb-3">
            <label for="" class="form-label">Dia trabajado</label>
            <select class="form-control" id="diaTrabajado" name="diaTrabajado" value="{{$liquidacion->diaTrabajado}}">
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="codPostal" name="codPostal" value="{{$liquidacion->codPostal}}">
